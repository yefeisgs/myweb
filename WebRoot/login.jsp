...
<html>
  ...
  <body>
     ...
     <form class="form-horizontal" action="${pageContext.request.contextPath}/users/login.mvc" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-4">
      <input  type="text" name="name" class="form-control" id="inputname" placeholder="请输入用户名">
    </div>
  </div>
  <div class="form-group">
